...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <button id="btn-create-permintaan" class="btn btn-primary"><i class="bi bi-plus-circle"></i> Buat Permintaan Baru</button>
</div>
<div class="card">
    <div class="card-body">
                    ...
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                <span class="badge <?php echo $status_class; ?>"><?php echo e($item['status_permintaan']); ?></span>
                            </td>
                            <td>
            ...
            <form id="form-permintaan">
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="catatan_pemohon" name="catatan_pemohon" rows="3" required></textarea>
                    </div>
                    <hr>
                    <h6>Item Barang yang Diminta</h6>
                    <div id="item-list"></div>
                    <button type="button" id="btn-add-item" class="btn btn-sm btn-outline-success mt-2"><i class="bi bi-plus"></i> Tambah Baris</button>
                </div>
        ...
        <div class="col-md-7">
            <select class="form-select item-barang" name="items[][id_barang]" required>
                ...
                <?php foreach ($barang_list as $barang): ?>
                    <option value="<?php echo e($barang['id_barang']); ?>"><?php echo e($barang['nama_barang']); ?> (Stok: <?php echo e($barang['stok_saat_ini']); ?>)</option>
                <?php endforeach; ?>
            </select>
        </div>
        <div class="col-md-3">
            <input type="number" class="form-control item-jumlah" name="items[][jumlah]" placeholder="Jumlah" min="1" required>
        </div>
        <div class="col-md-2">
